 ...
 */
function Shamsi_ASANAK($g_y, $g_m, $g_d, $mod = '')
{
    $d_4 = $g_y % 4;
...
function str_replace_tags_order($content, $order_status, $order_id, $order, $all_items, $vendor_items)
{
    ...
    if ($isTemplate == 'on') {
        $fields = array(
            'order_id' => $order_id,
            'b_first_name' => $order_billing_firstname,
            'b_last_name' => $order_billing_last_name,
            'b_company' => $order_billing_company,
            'b_address_1' => $order_billing_address_1,
            'b_address_2' => $order_billing_address_2,
            'b_state' => $bill_state,
            'b_city' => $order_billing_city,
            'b_postcode' => $order_billing_postcode,
            'b_country' => $bill_country,
            'sh_first_name' => $order_shipping_first_name,
            'sh_last_name' => $order_shipping_last_name,
            'sh_company' => $order_shipping_company,
            'sh_address_1' => $order_shipping_address_1,
            'sh_address_2' => $order_shipping_address_2,
            'sh_state' => $shipp_state,
            'sh_city' => $order_shipping_city,
            'sh_postcode' => $order_shipping_postcode,
...
function str_replace_tags_product($content, $product_id)
{
    ...
    if ($sale_price_dates_from != '') {
        ...
        $sale_price_dates_from = Shamsi_ASANAK($year, $month, $day, '/');
    }
    ...
    if ($sale_price_dates_to != '') {
        ...
        $sale_price_dates_to = Shamsi_ASANAK($year, $month, $day, '/');
    }
    $find = array(
        '{product_id}',
        '{sku}',
...
if (!function_exists('log_me')) {
    ...
    {
        $myfile = fopen("vahid_error.txt", "a");
